    ...
    <div className="app">
      <header className="app-header">
        <div>
          ...
          <p className="tagline">Ticket Price Watcher</p>
        </div>
      ...
      <section className="prose">
        ...
        <ul>
          ...
          <li>
            <strong>The events you watch</strong> and the thresholds you set, plus the price history
            we observe for those events.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          you when a condition you set is met. We do not sell or share your data.
        </p>

        <h2>Who else is involved</h2>
        <ul>
          <li>
            <strong>Ticketmaster</strong> — we query their public Discovery API for event and price
            data. We send them event searches, never your identity.
          </li>
          <li>
        ...
        <p>
          ...
          immediately — your watches, price history, and notification records are erased along with
        ...
        <p>
          Prices and availability come from Ticketmaster and are not guaranteed to be complete or
          current. Many events do not publish price data at all, in which case a price-based watch
          cannot trigger. Alerts are best-effort: this service polls within a limited API budget and
          should not be relied on for time-critical purchases.
        </p>
